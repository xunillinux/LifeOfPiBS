...
class Levels {
    ...
    private static levels: Level[] = [
        ...
        [
            new Transferpaper( Levels.getCoordinateForRelativeMapPos(33), Levels.getCoordinateForRelativeMapPos(8) ),
        ],
        [
        ...
        [
            new Bachelorthesis( Levels.getCoordinateForRelativeMapPos(15), Levels.getCoordinateForRelativeMapPos(9) ),
        ],
        [
